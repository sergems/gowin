  ...
  "group pointer-events-auto relative flex w-full items-start gap-3 overflow-hidden rounded-lg border p-4 pr-8 shadow-lg backdrop-blur-sm transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        ...
        success: "border-primary/40 bg-card text-card-foreground [&_[data-toast-icon]]:text-primary before:absolute before:inset-y-0 before:left-0 before:w-1 before:bg-primary",
        warning: "border-amber-500/40 bg-card text-card-foreground [&_[data-toast-icon]]:text-amber-400 before:absolute before:inset-y-0 before:left-0 before:w-1 before:bg-amber-400",
        destructive:
          "destructive group border-destructive/50 bg-card text-card-foreground [&_[data-toast-icon]]:text-destructive before:absolute before:inset-y-0 before:left-0 before:w-1 before:bg-destructive",
      },
    },
    defaultVariants: {
      variant: "default",

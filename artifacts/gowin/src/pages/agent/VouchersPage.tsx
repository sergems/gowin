    ...
    <div className="p-6 max-w-5xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white flex items-center gap-2">
          ...
          My Voucher Inventory
        </h1>
        <p className="text-zinc-400 mt-1">Sell and print vouchers allocated to you</p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="bg-zinc-800 border border-zinc-700 rounded-xl p-4 text-center">
          ...
          <p className="text-xs text-zinc-500 mt-0.5">Total Allocated</p>
        </div>
        <div className="bg-zinc-800 border border-zinc-700 rounded-xl p-4 text-center">
        ...
        <div className="bg-zinc-800 border border-zinc-700 rounded-xl p-4 text-center">
          ...
          <p className="text-xs text-zinc-500 mt-0.5">Sold</p>
        </div>
      </div>
                  ...
                  <tr key={v.id} className="hover:bg-zinc-700/30">
                    ...
                    <td className="px-5 py-3">
                      {v.isRedeemed
                        ...
                        : v.soldAt
                          ? <span className="text-xs px-2 py-0.5 rounded-full bg-blue-900/50 text-blue-400">Sold</span>
                          : <span className="text-xs px-2 py-0.5 rounded-full bg-emerald-900/50 text-emerald-400">Available</span>}
                    </td>
                    <td className="px-5 py-3 text-right">
                      {isAvailable && (
                        <div className="flex gap-2 justify-end">
                          ...
                          <button
                            onClick={() => { if (confirm("Mark this voucher as sold?")) sellMut.mutate(v.id); }}

...
import {
  ...
  TheLotterHungaryHatoslottoScraper,
  TheLotterHungaryOtoslottoScraper,
  TheLotterItalyLottoScraper,
  TheLotterItalyMillionDayScraper,
  TheLotterJapanLoto6Scraper,
  TheLotterJapanLoto7Scraper,
  TheLotterJapanMiniLotoScraper,
  TheLotterMexicoMelateScraper,
  TheLotterMexicoMelateRetroScraper,
  TheLotterMexicoChispazScraper,
  TheLotterPeruTinkaScraper,
  TheLotterPolandLottoScraper,
  TheLotterPolandMiniLottoScraper,
  TheLotterPortugalTotolotoScraper,
  TheLotterRomaniaJokerScraper,
  TheLotterRomaniaLoto649Scraper,
  TheLotterSpainBonolotoScraper,
  TheLotterSpainLaPrimitivaScraper,
...
const REGISTRY: Record<string, BaseScraper> = {
  ...
  TheLotterHungaryHatoslottoScraper:   new TheLotterHungaryHatoslottoScraper(),
  TheLotterHungaryOtoslottoScraper:    new TheLotterHungaryOtoslottoScraper(),
  TheLotterItalyLottoScraper:          new TheLotterItalyLottoScraper(),
  TheLotterItalyMillionDayScraper:     new TheLotterItalyMillionDayScraper(),
  TheLotterJapanLoto6Scraper:          new TheLotterJapanLoto6Scraper(),
  TheLotterJapanLoto7Scraper:          new TheLotterJapanLoto7Scraper(),
  TheLotterJapanMiniLotoScraper:       new TheLotterJapanMiniLotoScraper(),
  TheLotterMexicoMelateScraper:        new TheLotterMexicoMelateScraper(),
  TheLotterMexicoMelateRetroScraper:   new TheLotterMexicoMelateRetroScraper(),
  TheLotterMexicoChispazScraper:       new TheLotterMexicoChispazScraper(),
  TheLotterPeruTinkaScraper:           new TheLotterPeruTinkaScraper(),
  TheLotterPolandLottoScraper:         new TheLotterPolandLottoScraper(),
  TheLotterPolandMiniLottoScraper:     new TheLotterPolandMiniLottoScraper(),
  TheLotterPortugalTotolotoScraper:    new TheLotterPortugalTotolotoScraper(),
  TheLotterRomaniaJokerScraper:        new TheLotterRomaniaJokerScraper(),
  TheLotterRomaniaLoto649Scraper:      new TheLotterRomaniaLoto649Scraper(),
  TheLotterSpainBonolotoScraper:       new TheLotterSpainBonolotoScraper(),
  TheLotterSpainLaPrimitivaScraper:    new TheLotterSpainLaPrimitivaScraper(),

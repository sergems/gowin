...
router.get("/branch/bets", requireBranchAdmin, async (req: AuthRequest, res): Promise<void> => {
  ...
  const bets = await db
    .select({
      ...
      exchangeRate: betsTable.exchangeRate,
      cashOutAmount: betsTable.cashOutAmount,
      cashOutExchangeRate: betsTable.cashOutExchangeRate,
  ...
  res.json({
    bets: bets.map(b => ({
      ...
      exchangeRate: b.exchangeRate !== null && b.exchangeRate !== undefined ? parseFloat(b.exchangeRate as any) : null,
      cashOutAmount: b.cashOutAmount !== null && b.cashOutAmount !== undefined ? parseFloat(b.cashOutAmount as any) : null,
      cashOutExchangeRate: b.cashOutExchangeRate !== null && b.cashOutExchangeRate !== undefined ? parseFloat(b.cashOutExchangeRate as any) : null,
